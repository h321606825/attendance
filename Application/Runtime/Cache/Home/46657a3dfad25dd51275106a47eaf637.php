...
<div id="box">
    ...
    <div id="bodybox">
        <div id="addbox">
            ...
            <button class="addbutton"><a onclick="window.location.assign('/attendance/index.php/Home/User/add');" style="text-decoration: none" class="link">添&emsp;加</a></button>
        </div>
 ...
 $i = 0; for($i = 0; $i < count($data) ; $i++) { ?>
            <tr align="center">
                ...
                <td><?=$data[$i]['eml']?></td>
                <td align="center">
                    <img src="/attendance/Public//image/delete_rui.png" class="delete" onclick="del(<?=$data[$i]['work_id']?>);">
                    <img src="/attendance/Public//image/exit_rui.png" class="exit" onclick="upd(<?=$data[$i]['work_id']?>);">
                </td>
            </tr>
            <?php } for(; $i < 10; $i++) { ?>
            <tr align="center">
...
<script type="text/javascript">
    ...
    {
        $.ajax({
            url : '/attendance/index.php/Home/UserInfo/deleteinfo',
            method : 'post',
            data : {'work_id' : work_id},
            success : function()
            {
                alert("工号为 " + work_id + " 已被删除！！！！");
               window.location.assign('/attendance/index.php/Home/UserInfo');
            }
        })
    }
    function upd(work_id)
    {
        window.location.assign('/attendance/index.php/Home/User/add');
    }
</script>
</body>
</html>